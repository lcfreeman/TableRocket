...
if __name__ == "__main__":
    ...
    gtJsonFile = '/data/lcpang/lc/project_table/57result/TEDS/PTN/gtwohead_val.pkl'
    predFile = f'/data/lcpang/lc/project_table/57result/TEDS/PTN/e12_nms{thr}_query_tablehtml_result.pkl'
    ...
    with open(os.path.join(save_folder, f'e12PTN{thr}_tedsscore.txt'), 'w')as f:
    ...
    with open(os.path.join(save_folder, f'e12PTN{thr}_tedsscorefilename.pkl'), 'wb')as f:
        pickle.dump(save_file, f)
    #for file_name in caches.keys():
    #    info = caches[file_name]
    #    if info['score']._value < 1.0:
