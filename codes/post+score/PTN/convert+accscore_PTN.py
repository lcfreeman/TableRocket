...
def evaluate_image_generation(context1, gt_context1):
    ...
    htmlGtContext2 = htmlPostProcess1(gt_context1)
...
if __name__ == "__main__": 
    ...
    stru_gt_path = '/data1/lcpang/lc/project_table/dataset/Pubtabnet/ptn_val_struhtml_gt_wohead.pkl'
    save_folder = f'/data1/lcpang/lc/project_table/master_project/result/query_inst/result/CellBox/PTN/Convert/'
    for ithr in range(1,10):
        thr = ithr/100
        queryinst_result = f'/data1/lcpang/lc/project_table/master_project/result/query_inst/result/CellBox/PTN/e12_nms{thr}_result_queryinst_ptnval9115.pkl'
       ...
       #### get structure result
        ...
        save_dict = dict()
        err_list = []
        save_file = save_folder+f'e12_nms{thr}_query_struhtml_result.pkl'
        ...
        list2filew(save_folder+f'e12_nms{thr}_err_list.txt',err_list)
        
        stru_pred_path = f'/data1/lcpang/lc/project_table/master_project/result/query_inst/result/CellBox/PTN/Convert/e12_nms{thr}_query_struhtml_result.pkl'
        ...
        list2filew(save_folder+f'e12{thr}acc.jsonl',save_list)    
        
        data=json_lines.reader(open(save_folder+f'e12{thr}acc.jsonl','r'))
        ...
        average_acc=total_acc/9115
        with open(save_folder+f'e12{thr}_average_acc.txt','w')as f:
