...
if __name__ == "__main__":
    ...
    #gtJsonFile = '/data1/lcpang/lc/project_table/dataset/Pubtabnet/ptn_val_struhtml_gt_wohead.pkl'
    gtJsonFile = '/data/lcpang/lc/project_table/57result/TEDS/PTN/gt_struhtml_ptnval9115.pkl'
    predFile = f'/data/lcpang/lc/project_table/57result/TEDS/PTN/e12_nms{thr}_query_struhtml_result.pkl'
    ...
    for idx, (file_name, context) in enumerate(tqdm(predDict.items())):
        ...
        # print(file_name)
        score = pool.apply_async(func=singleEvaluation1, args=(teds, file_name, context, gt_context,))
        scores.append(score)
    ...
    with open(os.path.join(save_folder, f'e12PTN{thr}_stedsscore.txt'), 'w')as f:
    ...
    with open(os.path.join(save_folder, f'e12PTN{thr}_stedsscorefilename.pkl'), 'wb')as f:
        pickle.dump(save_file, f)
    #for file_name in caches.keys():
    #    info = caches[file_name]
    #    if info['score']._value < 1.0:
