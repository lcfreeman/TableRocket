...
data = dict(
    ...
    train=dict(
             ann_file='/share/home/pangliucheng/lc/project_table/dataset/GridCellLabel/PTN/PTNcellboxwcls_train.json',
            img_prefix='/share/home/pangliucheng/lc/project_table/dataset/PTN/pubtabnet/train/',
            classes = classes,
   ...
   test=dict( ann_file='/share/home/pangliucheng/lc/project_table/dataset/GridCellLabel/PTN/PTNcellboxwcls_val.json',
            img_prefix='/share/home/pangliucheng/lc/project_table/dataset/PTN/pubtabnet/val/',
            classes = classes,
            pipeline=test_pipeline
            ),
        
        val=dict(
             ann_file='/share/home/pangliucheng/lc/project_table/dataset/GridCellLabel/PTN/PTNcellboxwcls_val.json',
            img_prefix='/share/home/pangliucheng/lc/project_table/dataset/PTN/pubtabnet/val/',
            classes = classes,
            pipeline=test_pipeline
        )
...
load_from = '/share/home/pangliucheng/lc/project_table/work_dirs/cellwlcs_queryinst_small_PTN_train/resume2.5e-5/epoch_3.pth'
# 以PubTables-1M为训练集的best epoch=9 为模型初始化参数 2.5e-4为初始学习率
...
## /resume2.5e-4/epoch_3.pth
### /resume2.5e-5/epoch_3.pth
resume = False
runner = dict(type = 'EpochBasedRunner',max_epochs=12) 
optimizer = dict(type='AdamW', lr=1e-5,weight_decay=0.0001) #以2.5e-4为初始学习率,计划每隔2轮降低0.1倍.
## 学习率降低0.1
### 学习率降低0.2
...
work_dir = './work_dirs/cellwlcs_queryinst_small_PTN_train/'
gpu_ids = range(0, 2)